...
public class Silly implements Comparable<Silly> {
     ...
     *
     * @param first_string  a String for this Silly instance's first part of the name.
     * @param second_string a String for this Silly instance's last part of the name.
     */
